...
//To improve the performance pizzaDiv is made out of for loop
...
//variable to ensure requestAnimationFrame only runs when scroll event is fired
var scrolling;
...
function updatePositions() {
    ...
    for (i = 0; i < numbPizzas; i++) {
        var phase = constArray[i % 5];
        //instead of left, use transform which only triggers compositing
    ...
    //return scrolling state to false as updatePositions has finished
    scrolling = false;
}
